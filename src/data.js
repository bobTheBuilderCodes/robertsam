...
export const projects = [
  ...
  },
  {
    ...
    name: "CV Builder",
    desc: "A guided platform for creating polished, professional CVs with less formatting friction.",
    type: "purple",
    tags: ["Product design", "Guided workflows", "Document creation"],
    kind: "dashboard",
    status: "Completed",
  },
];
...
export const caseStudyContent = {
  ...
  dashboard: {
    title: "From blank page to professional story.",
    summary:
      "CV Builder is a digital platform designed to help users create professional, structured and visually appealing CVs without advanced design or document-formatting skills. It guides users through personal details, experience, education, skills, certifications and other career information, turning a tedious formatting task into a simple guided experience.",
    contribution:
      "As Product Designer, I designed an intuitive guided journey that helps users move from entering their professional information to producing a polished CV with minimal friction.",
    focus: ["Guided workflows", "Information architecture", "Document design", "Preview experience"],
    goals: [
      "Make CV creation simple and accessible.",
      "Guide users through the information they need to provide.",
      "Reduce the effort required to format a professional CV.",
      "Create a consistent and polished document structure.",
      "Allow users to easily update their information.",
      "Provide flexibility without overwhelming users.",
      "Help users produce a professional-looking CV quickly.",
    ],
    research: [
      "Considered first-time CV creators and professionals updating existing CVs.",
      "Explored where users struggle with structure, content and formatting.",
      "Identified the information users need to provide across CV sections.",
      "Examined how users expect to move between sections and preview their CV.",
      "Separated content creation from document formatting so the system can handle presentation complexity.",
    ],
    designProcess: [
      "Structured the experience around Personal Information → Summary → Experience → Education → Skills → Certifications → Additional Information → Preview.",
      "Designed a guided, progressive journey that lets users build their professional profile incrementally.",
      "Created reusable form, section navigation and preview patterns.",
      "Designed template browsing and selection experiences for different presentation needs.",
      "Made editing, reviewing, refining and downloading part of one connected workflow.",
      "Validated the experience through high-fidelity UI designs and prototypes.",
    ],
    impact: [
      "Transformed CV creation from a manual formatting task into a structured digital experience.",
      "Helped users focus on their professional story while the product handled layout and presentation.",
      "Created a clear path from entering information to producing a polished CV.",
    ],
    sections: [
      ["problem", "The Challenge", "Creating a CV can be challenging when users are unsure what information to include, how to structure their experience, or how to maintain consistent formatting. The key challenge was to let users focus on their professional story while the product handled the complexity of structure and presentation."],
      ["research", "User needs", "Explored first-time CV creation, CV updates, content requirements, section navigation, preview expectations and the difference between required and optional information."],
      ["strategy", "Guided CV journey", "Personal information → professional summary → experience → education → skills → certifications → additional information → preview."],
      ["ux", "Builder experience", "Designed progressive forms, section navigation, template browsing, editing and preview patterns to make CV creation feel like building a professional profile step by step."],
      ["ui", "Document presentation", "Designed reusable templates and a consistent visual structure so users can create polished CVs without manually managing typography, spacing or page layout."],
      ["build", "Review and delivery", "Connected data entry, preview, refinement and download into one coherent product workflow."],
      ["outcome", "Outcome", "Created a simpler, more accessible path for users to produce professional CVs with less formatting friction."],
      ["snapshots", "Design snapshots", "UI designs and Figma explorations for CV Builder."],
      ["learning", "Lessons learned", "Content creation becomes easier when the product takes responsibility for structure and presentation."],
    ],
  },
  mobile: {
...
export const workflowSections = {
  ...
  dashboard: [
    [
      ...
      "Workflow analysis",
      [
        "Mapped the journey from entering professional information to producing a polished CV.",
        "Separated content creation from formatting and presentation responsibilities.",
        "Identified friction across section navigation, editing, preview and template selection.",
      ],
    ],
    [
      "product-strategy",
      "Product strategy",
      [
        "Make CV creation accessible to users with different levels of technical and design ability.",
        "Let users focus on their professional story while the system handles document structure.",
        "Provide flexibility without overwhelming users with formatting decisions.",
      ],
    ],
    [
      "future-workflow",
      "Future-state workflow",
      [
        "Personal information → summary → experience → education → skills → certifications → preview.",
        "Connect guided entry, template selection, review and download into one experience.",
        "Allow users to update content without rebuilding the document layout manually.",
      ],
    ],
    [
      "automation-delivery",
      "Automation & delivery",
      [
        "Designed reusable form, section navigation, template and preview patterns.",
        "Created high-fidelity interfaces for guided CV creation and document review.",
        "Connected user-entered information to a consistent professional presentation.",
      ],
    ],
    [
      "workflow-outcome",
      ...
      [
        "Transformed CV creation from a manual formatting task into a structured digital experience.",
        "Reduced presentation complexity so users can focus on their professional content.",
        "Created a clear path from entering information to producing a polished CV.",
      ],
    ],
    [
      ...
      "Lessons learned",
      [
        "Guided workflows reduce cognitive load when users are creating information-heavy documents.",
        "Design systems are most valuable when they make consistency feel effortless.",
      ],
    ],
  ],
  mobile: [
